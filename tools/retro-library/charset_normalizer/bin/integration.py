...
from requests import __version__, get

from charset_normalizer import __version__ as __version_cn__
...
if __name__ == "__main__":
    ...
    for file in files:
        ...
        if expected_encoding != r.apparent_encoding:
            print(
                f"Integration test failed | File '{file}' | Expected '{expected_encoding}' got '{r.apparent_encoding}'"
            )
            exit(1)
