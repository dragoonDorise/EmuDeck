...
## READ THE WIKI FOR MOST UPDATED INFORMATION: https://github.com/dragoonDorise/EmuDeck/wiki
...
| Nintendo 64               | Retroarch Mupen64plus-Next<br>Rosalie's Mupen GUI                    | .7z .bin .n64 .ndd .u1 .v64 .z64 .zip                               |                                                                                                                                                                                                                           |
| Nintendo DS               | Retroarch melonDS core<br>MelonDS Standalone                        | .7z .nds .zip                                                       | bios7.bin<br>bios9.bin<br>firmware.bin                                                                                                                                                                                    |
| Nintendo GameBoy          | Retroarch Gambatte core<br>Retroarch SameBoy core                       | .7z .gb .dmg .zip                                                   |                                                                                                                                                                                                                           |
| Nintendo GameBoy Advance  | Retroarch mGBA<br>mGBA Standalone core                           | .7z .gba .zip                                                       |                                                                                                                                                                                                                           |
| Nintendo GameBoy Color    | Retroarch Gambatte core<br>Retroarch SameBoy core                       | .7z .gb .gbc .dmg .zip                                              |                                                                                                                                                                                                                           |
| Nintendo GameCube         | Dolphin Standalone                            | .ciso .dol .elf .gcm .gcz .iso .nkit.iso .rvz .wad .wia .wbfs       |                                                                                                                                                                                                                           |
| Nintendo NES              | Retroarch Nestopia core<br>Retroarch Mesen Core                       | .7z .nes .fds .unf .unif .zip                                       |                                                                                                                                                                                                                           |
| Nintendo PrimeHack        | PrimeHack (Metroid Prime specific)            | .ciso .dol .elf .gcm .gcz .iso .json .nkit.iso .rvz .wad .wia .wbfs |                                                                                                                                                                                                                           |
| Nintendo Switch           | Yuzu<br>Ryujinx                                          | .kp .nca .nro .nso .nsp .xci                                        | Title keys required for encrypted rom types<br>firmware installation with valid mii data required for some games                                                                                                          |
...
| Sony Playstation 2        | PCSX2                             | .bin .chd .cso .dump .gz .img .iso .mdf .nrg                        | Bios files are required. Here is an example set:<br>SCPH-70004\_BIOS\_V12\_EUR\_200.BIN<br>SCPH-70004\_BIOS\_V12\_EUR\_200.EROM<br>SCPH-70004\_BIOS\_V12\_EUR\_200.ROM1<br>SCPH-70004\_BIOS\_V12\_EUR\_200.ROM2           |
