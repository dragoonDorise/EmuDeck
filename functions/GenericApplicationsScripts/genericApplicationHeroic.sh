...
Heroic_uninstall() {
	...
	rm -f "$Heroic_emuPath"
	rm -f "$romsPath/generic-applications/Heroic-Games-Launcher.sh"
	rm -f "$romsPath/desktop/generic-applications/Heroic-Games-Launcher.sh"
	rm -f "$HOME/.local/share/applications/Heroic-Games-Launcher.desktop"
}
