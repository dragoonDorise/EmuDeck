...
def check_ryujinx_bios() -> bool:
    ...
    if system == "linux":
        ...
        keys = home / ".config" / "Ryujinx" / "system" / "prod.keys"
    if system.startswith("win"):
        fir = emus_folder / "Ryujinx" / "bis"    / "system" / "Contents" / "registered"
        keys = emus_folder / "Ryujinx" / "system" / "prod.keys"
