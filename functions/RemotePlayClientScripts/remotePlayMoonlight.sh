...
Moonlight_install() {
	...
	installEmuFP "${Moonlight_emuName}" "${Moonlight_emuPath}" "remoteplay"
}
...
Moonlight_update() {
	...
	updateEmuFP "${Moonlight_emuName}" "${Moonlight_emuPath}" "remoteplay"
}
...
Moonlight_uninstall() {
	...
	rm -f "$romsPath/remoteplay/Moonlight Game Streaming.sh"
	rm -f "$romsPath/desktop/remoteplay/Moonlight Game Streaming.sh"
