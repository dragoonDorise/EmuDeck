...
Ryujinx_install(){
    ...
    if installEmuBI "$Ryujinx_emuName" "https://github.com/Ryubing/Stable-Releases/releases/download/1.2.86/ryujinx-1.2.86-x64.AppImage" "" "tar.gz" "$showProgress"; then
