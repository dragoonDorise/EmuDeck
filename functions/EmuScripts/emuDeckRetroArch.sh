...
RetroArch_pcengine_bezelOn(){
	...
	RetroArch_setOverride 'pcengine.cfg' 'Beetle PCE Fast'  'input_overlay' "'$RetroArch_overlays/pegasus/pcengine.cfg'"
	...
	RetroArch_setOverride 'pcengine.cfg' 'Beetle PCE'  'input_overlay' "'$RetroArch_overlays/pegasus/pcengine.cfg'"
	...
	RetroArch_setOverride 'tg16.cfg' 'Beetle PCE Fast'  'input_overlay' "'$RetroArch_overlays/pegasus/pcengine.cfg'"
	...
	RetroArch_setOverride 'tg16.cfg' 'Beetle PCE'  'input_overlay' "'$RetroArch_overlays/pegasus/pcengine.cfg'"
...
RetroArch_nes_bezelOn(){
	RetroArch_setOverride 'nes.cfg' 'Mesen'  'input_overlay' "'$RetroArch_overlays/pegasus/nes.cfg'"
	...
	RetroArch_setOverride 'nes.cfg' 'Nestopia'  'input_overlay' "'$RetroArch_overlays/pegasus/nes.cfg'"
...
RetroArch_lynx_bezelOn(){
	...
	RetroArch_setOverride 'lynx.cfg' 'Beetle Lynx'  'input_overlay' "'$RetroArch_overlays/pegasus/lynx.cfg'"
	...
	RetroArch_setOverride 'atarilynx.cfg' 'Handy'  'input_overlay' "'$RetroArch_overlays/pegasus/lynx.cfg'"
...
RetroArch_ngp_bezelOn(){
	...
	RetroArch_setOverride 'ngp.cfg' 'Beetle NeoPop'  'input_overlay' "'$RetroArch_overlays/pegasus/ngpc.cfg'"
...
RetroArch_ngpc_bezelOn(){
	...
	RetroArch_setOverride 'ngpc.cfg' 'Beetle NeoPop'  'input_overlay' "'$RetroArch_overlays/pegasus/ngpc.cfg'"
...
RetroArch_atari2600_bezelOn(){
	RetroArch_setOverride 'atari2600.cfg' 'Stella'  'input_overlay' "'$RetroArch_overlays/pegasus/atari2600.cfg'"
...
RetroArch_segacd_bezelOn(){
	RetroArch_setOverride 'megacd.cfg' 'Genesis Plus GX'  'input_overlay' "'$RetroArch_overlays/pegasus/segacd.cfg'"
	...
	RetroArch_setOverride 'segacd.cfg' 'Genesis Plus GX'  'input_overlay' "'$RetroArch_overlays/pegasus/segacd.cfg'"
...
RetroArch_genesis_bezelOn(){
	RetroArch_setOverride 'genesis.cfg' 'Genesis Plus GX'  'input_overlay' "'$RetroArch_overlays/pegasus/genesis.cfg'"
	...
	RetroArch_setOverride 'megadrive.cfg' 'Genesis Plus GX'  'input_overlay' "'$RetroArch_overlays/pegasus/genesis.cfg'"
...
RetroArch_gamegear_bezelOn(){
	...
	RetroArch_setOverride 'gamegear.cfg' 'Genesis Plus GX'  'input_overlay' "'$RetroArch_overlays/pegasus/gg.cfg'"
	...
	RetroArch_setOverride 'gamegear.cfg' 'Gearsystem'  'input_overlay' "'$RetroArch_overlays/pegasus/gg.cfg'"
...
RetroArch_mastersystem_bezelOn(){
	...
	RetroArch_setOverride 'mastersystem.cfg' 'Genesis Plus GX'  'input_overlay' "'$RetroArch_overlays/pegasus/mastersystem.cfg'"
...
RetroArch_sega32x_bezelOn(){
	RetroArch_setOverride 'sega32x.cfg' 'PicoDrive'  'input_overlay' "'$RetroArch_overlays/pegasus/sega32x.cfg'"
	...
	RetroArch_setOverride 'sega32xna.cfg' 'PicoDrive'  'input_overlay' "'$RetroArch_overlays/pegasus/sega32x.cfg'"
...
RetroArch_gb_bezelOn(){
	...
	RetroArch_setOverride 'gb.cfg' 'SameBoy'  'input_overlay' "'$RetroArch_overlays/pegasus/gb.cfg'"
	...
	RetroArch_setOverride 'gb.cfg' 'Gambatte'  'input_overlay' "'$RetroArch_overlays/pegasus/gb.cfg'"
...
RetroArch_gbc_bezelOn(){
	...
	RetroArch_setOverride 'gbc.cfg' 'SameBoy'  'input_overlay' "'$RetroArch_overlays/pegasus/gbc.cfg'"
	...
	RetroArch_setOverride 'gbc.cfg' 'Gambatte'  'input_overlay' "'$RetroArch_overlays/pegasus/gbc.cfg'"
...
RetroArch_n64_bezelOn(){
	RetroArch_setOverride 'n64.cfg' 'Mupen64Plus-Next'  'aspect_ratio_index' '"0"'
	RetroArch_setOverride 'n64.cfg' 'Mupen64Plus-Next'  'input_overlay' "'$RetroArch_overlays/pegasus/N64.cfg'"
...
RetroArch_atari800_bezelOn(){
	...
	RetroArch_setOverride 'atari800.cfg' 'Stella'  'input_overlay' "'$RetroArch_overlays/pegasus/atari800.cfg'"
...
RetroArch_atari5200_bezelOn(){
	...
	RetroArch_setOverride 'atari5200.cfg' 'Stella'  'input_overlay' "'$RetroArch_overlays/pegasus/atari5200.cfg'"
...
RetroArch_dreamcast_bezelOn(){
	...
	RetroArch_setOverride 'dreamcast.cfg' 'Flycast'  'input_overlay' "'$RetroArch_overlays/pegasus/Dreamcast.cfg'"
...
RetroArch_saturn_bezelOn(){
	...
	RetroArch_setOverride 'saturn.cfg' 'Yabause'  'input_overlay' "'$RetroArch_overlays/pegasus/saturn.cfg'"
	...
	RetroArch_setOverride 'saturn.cfg' 'YabaSanshiro'  'input_overlay' "'$RetroArch_overlays/pegasus/saturn.cfg'"
	...
	RetroArch_setOverride 'saturn.cfg' 'Kronos'  'input_overlay' "'$RetroArch_overlays/pegasus/saturn.cfg'"
	...
	RetroArch_setOverride 'saturn.cfg' 'Beetle Saturn'  'input_overlay' "'$RetroArch_overlays/pegasus/saturn.cfg'"
...
RetroArch_snes_bezelOn(){
	RetroArch_setOverride 'snes.cfg' 'Snes9x'  'input_overlay' "'$RetroArch_overlays/pegasus/snes.cfg'"
	...
	RetroArch_setOverride 'snesna.cfg' 'Snes9x'  'input_overlay' "'$RetroArch_overlays/pegasus/snes.cfg'"
...
RetroArch_snes_ar87(){
	RetroArch_setOverride 'snes.cfg' 'Snes9x'  'input_overlay' "'$RetroArch_overlays/pegasus/snes87.cfg'"
	...
	RetroArch_setOverride 'snesna.cfg' 'Snes9x'  'input_overlay' "'$RetroArch_overlays/pegasus/snes87.cfg'"
...
RetroArch_psx_bezelOn(){
	...
	RetroArch_setOverride 'psx.cfg' 'Beetle PSX HW' 'input_overlay' "'$RetroArch_overlays/pegasus/psx.cfg'"
	...
	RetroArch_setOverride 'psx.cfg' 'Beetle PSX' 'input_overlay' "'$RetroArch_overlays/pegasus/psx.cfg'"
	...
	RetroArch_setOverride 'psx.cfg' 'SwanStation' 'aspect_ratio_index' '"0"'
	RetroArch_setOverride 'psx.cfg' 'SwanStation' 'input_overlay' "'$RetroArch_overlays/pegasus/psx.cfg'"
