...
SRM_init(){			
	...
	mkdir -p "$HOME/.config/steam-rom-manager/userData/img"
	...
	rsync -avzh "$EMUDECKGIT/configs/steam-rom-manager/userData/img/" "$HOME/.config/steam-rom-manager/userData/img/"
	sleep 3
	tmp=$(mktemp)
