...
SRM_addSteamInputProfiles(){
   ...
   ln -s "$HOME/.config/EmuDeck/backend/steam-input/emudeck_cloud_controller_config.vdf" "$HOME/.steam/steam/controller_base/templates/emudeck_cloud_controller_config.vdf"
   ln -s "$HOME/.config/EmuDeck/backend/steam-input/emudeck_controller_generic.vdf" "$HOME/.steam/steam/controller_base/templates/emudeck_controller_generic.vdf"
   ln -s "$HOME/.config/EmuDeck/backend/steam-input/emudeck_controller_ps4.vdf" "$HOME/.steam/steam/controller_base/templates/emudeck_controller_ps4.vdf"
   ln -s "$HOME/.config/EmuDeck/backend/steam-input/emudeck_controller_ps5.vdf" "$HOME/.steam/steam/controller_base/templates/emudeck_controller_ps5.vdf"
   ln -s "$HOME/.config/EmuDeck/backend/steam-input/emudeck_controller_steamdeck_nintendo.vdf" "$HOME/.steam/steam/controller_base/templates/emudeck_controller_steamdeck_nintendo.vdf"
   ln -s "$HOME/.config/EmuDeck/backend/steam-input/emudeck_controller_steamdeck.vdf" "$HOME/.steam/steam/controller_base/templates/emudeck_controller_steamdeck.vdf"
   ln -s "$HOME/.config/EmuDeck/backend/steam-input/emudeck_controller_switch_pro.vdf" "$HOME/.steam/steam/controller_base/templates/emudeck_controller_switch_pro.vdf"
   ln -s "$HOME/.config/EmuDeck/backend/steam-input/emudeck_controller_xbox360.vdf" "$HOME/.steam/steam/controller_base/templates/emudeck_controller_xbox360.vdf"
   ln -s "$HOME/.config/EmuDeck/backend/steam-input/emudeck_controller_xboxone.vdf" "$HOME/.steam/steam/controller_base/templates/emudeck_controller_xboxone.vdf"
