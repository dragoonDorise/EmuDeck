...
if [ $(getScreenAR) == 169 ];then
	...
	sed -i "s|input_overlay_scale_landscape = "1.070000"|input_overlay_scale_landscape = "1.100000"|" "${nestopiaPath}nes.cfg"
	sed -i "s|input_overlay_aspect_adjust_landscape = "0.000000"|input_overlay_aspect_adjust_landscape = "-0.135000"|" "${nestopiaPath}nes.cfg"
	sed -i "s|input_overlay_scale_landscape = "1.070000"|input_overlay_scale_landscape = "1.100000"|" "${mesenPath}nes.cfg"
	sed -i "s|input_overlay_aspect_adjust_landscape = "0.000000"|input_overlay_aspect_adjust_landscape = "-0.135000"|" "${mesenPath}nes.cfg"
	...
	#Beetle NeoPop
	NeoPopPath="${RApath}Beetle PCE Fast/"
	sed -i "s|input_overlay_scale_landscape = "1.615000"|input_overlay_scale_landscape = "1.575000"|" "${NeoPopPath}pcengine.cfg"
	sed -i "s|input_overlay_x_separation_portrait = "-0.010000"|input_overlay_x_separation_portrait = "0.000000"|" "${NeoPopPath}pcengine.cfg"
	sed -i "s|input_overlay_y_offset_landscape = "-0.135000"|input_overlay_y_offset_landscape = "-0.130000"|" "${NeoPopPath}pcengine.cfg"
	sed -i "s|input_overlay_aspect_adjust_landscape = "-0.170000"|input_overlay_aspect_adjust_landscape = "-0.265000"|" "${NeoPopPath}pcengine.cfg"
